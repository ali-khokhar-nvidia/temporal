...
scoped by namespace and/or task queue.`,
	...
	MatchingPollerScalingImprovedSignals = NewTaskQueueBoolSetting(
		"matching.pollerScalingImprovedSignals",
		false,
		`MatchingPollerScalingImprovedSignals, when enabled, uses improved scaling signals for poller autoscaling:
